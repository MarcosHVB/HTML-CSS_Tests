...
<div class="fundo">
        ...
        <img src="../imgs/logoOf.png" class="logoImg" alt="logo">
                ...
                <ul class="login">
                    <li><a href="loginCadastro.php">Login/Cadastro</a></li>
                </ul>
        ...
        <div class="main">
            <div clas="alignProduct">
                <div class="product">         
                    <form method="POST" action="#">
                            <h3 class="titleProd">Produto</h3><br>
                            <img class="img" src="../imgs/lingerie.jpg">  
                            <br><br>
                            <h3 class="titleProd">R$ 1000,00</h3>
                            <br>
