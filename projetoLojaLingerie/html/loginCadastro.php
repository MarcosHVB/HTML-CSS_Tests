...
<div class="fundo">
        ...
        <form method="post" class="formLogin" action="receberDados.php">
            <div class="fieldset">
                ...
                <br>
                <input type="email" id="emailLogin" class="inputLogin" name="email" tabindex="1" placeholder="Digite seu email aqui">
                <br>

                <label class="labelLogin" for="senhaLogin">Senha</label>
                <br>
                <input type="password" id="senhaLogin" class="inputLogin" name="senha" tabindex="2" placeholder="Digite sua senha">
                <br>

                <input type="submit" class="buttonLogin" name="enviar" value="Enviar">    <br>
                <span class="cadastro"><a href="#" class="linkCadastro">Esqueceu a senha?</a><a href="cadastro.php" class="linkCadastro">Se cadastre!</a></span> 
